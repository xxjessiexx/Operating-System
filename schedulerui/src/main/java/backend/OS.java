...
public class OS {
    ...
    public void runOneStep() {
        ...
        for (Process p : processes) {
            ...
            // Waiting time logic - same as old run()
            if (p.pcb != null
...
///////////getting mutex for semwait and semsignal
    ...
    public String getReadyQueueSnapshot() {
        return scheduler.readyQueueAsString();
    }

    public String getBlockedQueueSnapshot() {
        return scheduler.blockedQueueAsString();
    }

    public String getPQ0Snapshot() {
        return scheduler.pq0AsString();
    }

    public String getPQ1Snapshot() {
        return scheduler.pq1AsString();
    }

    public String getPQ2Snapshot() {
        return scheduler.pq2AsString();
    }

    public String getPQ3Snapshot() {
        return scheduler.pq3AsString();
    }
